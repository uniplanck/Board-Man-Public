...
> Status: free-only public edition. This repository contains the open-source Board-Man core and intentionally excludes private paid-product source code and private commercial infrastructure.
...
- Source repository: https://github.com/uniplanck/Board-Man-Public
- Binary releases may be published separately after signing and release verification.
...
```bash
git clone https://github.com/uniplanck/Board-Man-Public.git
cd Board-Man-Public
xcodebuild \
...
See [`PUBLIC_BOUNDARY.md`](PUBLIC_BOUNDARY.md) for the repository boundary.
